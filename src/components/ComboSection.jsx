...
const ComboSection = () => {
    return (
        <section className="py-12 md:py-20 bg-[var(--color-cream)] overflow-hidden">
            <div className="container mx-auto px-4 md:px-8">
                <div className="flex flex-col md:flex-row justify-between items-end mb-8 md:mb-12">
                    <div className="max-w-xl text-center md:text-left">
                        <h2 className="text-2xl md:text-5xl font-heading font-bold text-[var(--color-primary-red)] mb-3 md:mb-4 flex items-center justify-center md:justify-start gap-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    {combos.map((combo) => (
                        <div key={combo.id} className="bg-white rounded-3xl p-5 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-yellow-100 flex flex-col h-full transform hover:-translate-y-2 relative">
                            ...
                            <h3 className="text-xl md:text-2xl font-bold font-heading text-[var(--color-dark-text)] mb-2 md:mb-3">{combo.name}</h3>
                            ...
                            <div className="flex items-center justify-between mb-4 md:mb-6">
                                <div>
                                    ...
                                    <span className="text-2xl md:text-3xl font-bold text-[var(--color-primary-red)]">₹{combo.price}</span>
                                </div>
                            ...
                            <button
                                className="w-full py-3 md:py-4 bg-[var(--color-dark-text)] hover:bg-[var(--color-primary-red)] text-white rounded-xl font-bold text-sm md:text-lg transition-colors flex justify-center items-center gap-2"
                                onClick={() => {
