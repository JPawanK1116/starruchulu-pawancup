...
const WhatsAppFloat = () => {
    ...
    return (
        <button
            onClick={handleClick}
            className="fixed bottom-10 right-4 md:right-8 lg:right-10 z-[55] w-14 h-14 bg-green-500 rounded-full flex items-center justify-center shadow-2xl hover:bg-green-600 hover:scale-110 transition-all duration-300 animate-bounce cursor-pointer group"
